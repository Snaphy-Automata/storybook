...
class NewTask extends PureComponent {
    ...
    _onTitleBlur = (value) => {
        const {onTaskSaveOnBlurAction, sectionId, taskId, createOrEditTaskMutation} = this.props
        ...
        if (!value || value === "") {
            ...
            onTaskSaveOnBlurAction(taskId, value, sectionId, createOrEditTaskMutation)
            //generate the id..
